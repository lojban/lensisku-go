// Package docs contains auto-generated code for Swagger API documentation.
// This code is typically generated by a tool like `swaggo/swag` by parsing
// special comments (annotations) in the application's handler/controller code.
// In a Nest.js application, API documentation is often generated using the `@nestjs/swagger` module,
// which also relies on decorators (similar to annotations) in controller and DTO files.
// Package docs Code generated by swaggo/swag. DO NOT EDIT
package docs

import "github.com/swaggo/swag"

// `docTemplate` is a string constant holding the entire Swagger/OpenAPI specification in JSON format.
// This template is populated with values from `SwaggerInfo` during initialization.
const docTemplate = `{
...
// This struct is used by the `swag` library to store metadata about the API.
// SwaggerInfo holds exported Swagger Info so clients can modify it
...
// `init()` is a special Go function that is executed automatically when the package is imported.
// This `init` function registers the `SwaggerInfo` with the `swag` library, making the
// generated documentation available to be served (e.g., via `http-swagger` handler).
func init() {
